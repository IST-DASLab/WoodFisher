...
FISHER_MINI_BSZ=400
LAYER_INFO='all'
EXP_NAME="exp_str_prune_($MODEL)_($TARGET)_${LAYER_INFO}_epochs_($EPOCHS)_($PRUNER)_($FISHER_SUBSAMPLE_SIZE)_($FISHER_MINI_BSZ)_($FITTABLE)_again_rep"
...
--workers=20 --batch_size=180 --logging_level debug --gpus=0,1,2,3 \
